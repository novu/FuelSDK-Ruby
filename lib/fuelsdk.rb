...
module FuelSDK
  ...
  require 'fuelsdk/soap/cud_module'
  require 'fuelsdk/soap/read_module'
  require 'fuelsdk/soap'
  require 'fuelsdk/rest'
  require 'fuelsdk/rest/cud_module'
  require 'fuelsdk/rest/read_module'
  require 'fuelsdk/rest'
